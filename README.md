...
Usage example:
  ...
  1. Create a subfolder (within this program's directory) containing some reference photos of a face you wish to detect. Have at least ten photos. Name the prime reference photo 'face'. Call this folder 'database'.
